...
def run_benchmark(algorithm: BaseAlgorithm, original_frames: list):
...
if __name__ == '__main__':
    VIDEO_PATH = '/mnt/c/Users/User/Desktop/bku/251/MCUCoder/MCUCoder/video/dancing_resized.mp4'
    ...
    for q in mjpeg_configs:
        ...
        final_results.append(run_benchmark(algo, frames))
